...
const Header = () => {
  return (
    <section className="font-sans bg-[#1B1714] lg:h-screen items-end justify-center w-full flex">
      <div className="flex flex-col lg:flex-row gap-10 md:gap-16 lg:gap-4 items-center justify-between  text-center lg:text-start px-[2rem] lg:px-[6rem] py-10 lg:mb-[4%] w-full">
        ...
        <div className="">
          <Image src={"/Images/lock2.png"} width={250} height={250} className="w-[150px] md:w-[200px] lg:w-[250px]"/>
        </div>
      </div>
    </section>
  );
